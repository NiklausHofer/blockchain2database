	...
	<ul id="main-menu" class="dropdown">
		<li>
			...
			<ul class="ui-state-default">
				...
				<li class="db option mysql4 mysql5 mysqli sqlite sqlite3 pgsql"><a class="ibatch" href="javascript:dbBatch()" title="<?php echo __('Perform one or more batch operations on database'); ?>"><?php echo __('Batch operations'); ?>...</a></li>
				<li class="db option mysql4 mysql5 pgsql mysqli sqlite sqlite3"><a class="iexpdb" href="javascript:dataExport()" title="<?php echo __('Export database to external file'); ?>"><?php echo __('Export'); ?>...</a></li>
				-->
			</ul>
		...
		<li class="db">
			...
			<!-- REMOVE UNWANTED FEATURES
				<li class="option mysql5 mysqli"><a class="itable" href="javascript:tableCreate()" title="<?php echo __('Create a new table in the database'); ?>"><?php echo __('Create Table'); ?>...</a></li>
				<li class="option sqlite sqlite3 pgsql"><a class="itable" href="javascript:javascript:objCreate(0)" title="<?php echo __('Create a new table in the database'); ?>"><?php echo __('Create Table'); ?>...</a></li>
				<li class="option mysql5 mysqli pgsql sqlite sqlite3"><a class="iview" href="javascript:objCreate(1)" title="<?php echo __('Create a new view in the database'); ?>"><?php echo __('Create View'); ?>...</a></li>
				
								<li class="option mysql5 mysqli pgsql sqlite sqlite3"><a class="itrig" href="javascript:objCreate(4)" title="<?php echo __('Create a new trigger in the database'); ?>"><?php echo __('Create Trigger'); ?>...</a></li>
...
<!-- REMOVE FEATURES
		<li>
			...
			<ul class="ui-state-default">
				<li class="option mysql4 mysql5 mysqli pgsql sqlite sqlite3"><a class="iimprt" href="javascript:dataImport()" title="<?php echo __('Import multiple queries from batch file'); ?>"><?php echo __('Import batch file'); ?>...</a></li>
				<li class="option mysql4 mysql5 mysqli pgsql sqlite sqlite3"><a class="iimprt" href="javascript:tableImport()" title="<?php echo __('Import table data from external file'); ?>"><?php echo __('Import table data'); ?>...</a></li>
				<li class="db option mysql4 mysql5 pgsql mysqli sqlite sqlite3"><a class="iexpdb" href="javascript:dataExport()" title="<?php echo __('Export database to batch file as sql dump'); ?>"><?php echo __('Export database'); ?>...</a></li>
