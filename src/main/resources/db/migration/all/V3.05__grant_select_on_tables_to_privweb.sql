...
GRANT SELECT, SHOW VIEW ON TABLE script_type TO 'privweb'@'localhost';
...
GRANT SELECT, SHOW VIEW ON TABLE unlock_script_multisig TO 'privweb'@'localhost';
-- table multisig_signature created in file V1.22__create_table_multisig_signature.sql
GRANT SELECT, SHOW VIEW ON TABLE multisig_signature TO 'privweb'@'localhost';
-- table unlock_script_p2raw_pub_key created in file V1.23__create_table_unlock_script_p2raw_pub_key.sql
GRANT SELECT, SHOW VIEW ON TABLE unlock_script_p2raw_pub_key TO 'privweb'@'localhost';
-- table unlock_script_other created in file V1.24__create_table_unlock_script_other.sql
GRANT SELECT, SHOW VIEW ON TABLE unlock_script_other TO 'privweb'@'localhost';
