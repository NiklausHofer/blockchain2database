...
public class PubKeyManager {
	...
	INSERT_IGNORE_KEY_HASH =
	"INSERT IGNORE INTO public_key (pubkey_hash) VALUES(?)"

	;
	
	public long getPKIdFromPubKeyHash(DatabaseConnection connection,String pkHash){
