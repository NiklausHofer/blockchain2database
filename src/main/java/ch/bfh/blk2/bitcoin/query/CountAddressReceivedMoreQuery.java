...
public class CountAddressReceivedMoreQuery implements Query<Long> {
	...
	private static final String SQL = "call count_addr_which_received_higher_than(?)";
	...
	public String resultToString() {
		...
		if (this.result < 1)
			...
			return "found " + this.result + " addresses that received more than " + this.amount + " satoshi";
	}
